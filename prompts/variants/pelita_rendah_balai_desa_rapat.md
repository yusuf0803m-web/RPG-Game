# Pelita Rendah — Balai Desa (varian)

Asset:
pelita_rendah/balai_desa_rapat.webp
...
```json
{
  ...
  "lighting": "lantern",
  "camera": "eye_level",
  "variant_of": "pelita_rendah/balai_desa.webp"
}
```
