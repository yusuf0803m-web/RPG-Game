# Pelita Rendah — Jalan Desa (varian)

Asset:
pelita_rendah/jalan_desa_sepi.webp
...
```json
{
  ...
  "camera": "eye_level",
  "variant_of": "pelita_rendah/jalan_desa.webp"
}
```
