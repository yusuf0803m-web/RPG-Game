# Pelita Rendah — Warung Bu Ratna (varian)

Asset:
pelita_rendah/warung_pulih.webp
...
```json
{
  ...
  "lighting": "lantern",
  "camera": "eye_level",
  "variant_of": "pelita_rendah/warung.webp"
}
```
