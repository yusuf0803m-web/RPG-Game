# Ibukota Tengara — Pasar Bawah (varian)

Asset:
tengara/pasar_bawah_siaga.webp
...
```json
{
  ...
  "lighting": "lantern",
  "camera": "eye_level",
  "variant_of": "tengara/pasar_bawah.webp"
}
```
